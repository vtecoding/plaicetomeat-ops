...
const checks=[
  ...
  ["authenticated redirects retry notification open evidence",openRecorder.includes("useSearchParams")&&openRecorder.includes("[searchParams]")],
