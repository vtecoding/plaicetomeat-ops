...
Generated: 2026-07-09T23:41:46.766Z
...
- **Check V6.4 Intake Lamb Leg 1782913405834 now** → `/admin/stock-count` (one tap to the work)
...
- PASS: Do-now actions link straight to the work (one tap, with focus context) — 3/3 carry from=today: Check Chicken Breast Fillets now → /admin/stock-count | Check V6.4 Intake Lamb Leg 1782913405834 now → /admin/stock-count | Check V6.4 Intake Lamb Leg 1782913606617 now → /admin/stock-count
